...
const fields: EditableContent[] = [
  ...
  { section_key: 'facilities', field_key: 'title', value_en: '', value_ar: '', content_type: 'text', is_active: true, display_order: 10 },
  { section_key: 'facilities', field_key: 'body', value_en: '', value_ar: '', content_type: 'textarea', is_active: true, display_order: 20 },
  { section_key: 'surgery_recovery', field_key: 'title', value_en: '', value_ar: '', content_type: 'text', is_active: true, display_order: 10 },
  { section_key: 'surgery_recovery', field_key: 'body', value_en: '', value_ar: '', content_type: 'textarea', is_active: true, display_order: 20 },
  { section_key: 'laser_dermatology', field_key: 'title', value_en: '', value_ar: '', content_type: 'text', is_active: true, display_order: 10 },
  { section_key: 'laser_dermatology', field_key: 'body', value_en: '', value_ar: '', content_type: 'textarea', is_active: true, display_order: 20 },
